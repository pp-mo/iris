...
def plot_ucube_edges(ucube):
    """Make a simple plot that shows nodes, edges and faces."""
    assert ucube.attributes['location'] == 'edge'
    ...
    print(color_values)
    plt.triplot(tri, '-', color=[0.25, 0.5, 0.75], linewidth=5.0)
#    plt.triplot(tri, 'o', color='red')
